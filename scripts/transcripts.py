...
def extract_conversation_context(
    ...
    *,
    ...
    """Read a JSONL transcript and extract recent user/assistant turns as markdown."""
    turns: list[str] = []
...
def content_to_text(content: Any) -> str:
    """Convert string/list content blocks from supported transcript formats to text."""
